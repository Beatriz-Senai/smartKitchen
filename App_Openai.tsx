...
export default function App() {
  ...
  function salvarReceita() {
    if (!receita) {
      Alert.alert("Nada para salvar", "Gere uma receita primeiro.");
      return;
    }
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 24, marginTop: 4}} style={ESTILOS.containerScroll} showsVerticalScrollIndicator={false}>
        ...
        {receita && (
          <View style={ESTILOS.content}>
            ...
            <Text style={{ lineHeight: 24, marginBottom: 16, color:'#fff' }}>{receita}</Text>

            <TouchableOpacity style={ESTILOS.botaoSalvar} onPress={salvarReceita}>
              <Text style={ESTILOS.textoBotaoSalvar}>Salvar Receita</Text>
            </TouchableOpacity>
          </View>
        )}
      </ScrollView>
